...
### This script performs Ribo-Seq specific quality check relying mostly on the Ribowaltz Bioconductor package
...
LENGTHRANGE=RIBO_LEN_MIN:RIBO_LEN_MAX
...
## Analysis
### We used Ribowaltz package to extract and compute metric of a P-sites (eg. 3-nt periodicity, frame preference)
